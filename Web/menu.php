...
<body class="bg-light">
  ...
  <div class="jumbotron jumbotron-fluid">
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
      ...
      <div class="row">
        <div class="col-sm-12 text-center">
          <button type="button" name="piada"  onclick="window.location='menu.php?piada'" data-toggle="tooltip" data-placement="bottom" title="Le nostre piade!" class="border border-top-0 border-bottom-0 border-left-0 text-dark display-7"> Piada</button>
          <button type="button" name="rotolo" onclick="window.location='menu.php?rotolo'" data-toggle="tooltip" data-placement="bottom" title="I nostri rotoli!" class="border border-top-0 border-bottom-0 border-left-0 text-dark"> Rotolo</button>
          <button type="button" name="cassone" onclick="window.location='menu.php?cassone'" data-toggle="tooltip" data-placement="bottom" title="I nostri cassoni!"class="border border-top-0 border-bottom-0 border-left-0 text-dark"> Cassone</button>
          <button type="button" name="bibita" onclick="window.location='menu.php?bibita'" data-toggle="tooltip" data-placement="bottom" title="Le nostre bibite!" class="border border-0 text-dark"> Bibita</button>
        </div>
      </div>
      ...
      <div class="row" id="tabella">
        ...
        if(isset($_GET['piada'])){
          showPiada();
        } else if (isset($_GET['rotolo'])) {
          showRotolo();
        } else if (isset($_GET['cassone'])) {
          showCassone();
        } else if (isset($_GET['bibita'])){
          showBibita();
        }else{
          showPiada();
        } ?>
