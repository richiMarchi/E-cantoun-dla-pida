  ...
  <div class="col-sm-9">
    <div class="table-responsive">
      <table class="table table-striped ">
            <tr class="righe">
              <th id="indirizzo" class= "sinistra">Indirizzo:</td>
              <td headers="indirizzo" class= "destra">E cantoun dla pida, via del Maniero, 17</td>
            </tr>
            <tr class="righe">
              <th id="telefono" class= "sinistra">Telefono:</td>
              <td headers="telefono" class= "destra">0547-000000</td>
            </tr>
            <tr class="righe">
              <th id="email" class= "sinistra">Email:</td>
              <td headers="email" class= "destra">ecantoun@mail.it</td>
            </tr>
            <tr class="righe">
              <th id="orari" rowspan="7 "class= "sinistra">Orari:</td>
              <td headers="orari" class= "destra">Lun: 11-22</td>
            </tr>
            <tr class="righe">
              <td headers="orari" class= "destra">Mar: 11-22</td>
            </tr>
            <tr class="righe">
              <td headers="orari" class= "destra">Mer: 11-22</td>
            </tr>
            <tr class="righe">
              <td headers="orari" class= "destra">Gio: CHIUSO</td>
            </tr>
            <tr class="righe">
              <td headers="orari" class= "destra">Ven: 11-22</td>
            </tr>
            <tr class="righe">
              <td headers="orari" class= "destra">Sab: 11-22</td>
            </tr>
            <tr class="righe">
              <td headers="orari" class= "destra">Dom: 18-22</td>
            </tr>
          </table>
        </div>
      </div>
