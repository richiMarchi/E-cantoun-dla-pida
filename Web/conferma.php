...
<div id="tabella" class="row">
  <div class="col-md-6">
    <div class="container">
      <h2 class="text-center">Le tue scelte:</h2>
      ...
      <table class="table table-dark table-striped text-center">
        ...
        ?> <tr>
          <td headers="prodotto"><?php echo $carrello[$i]['prodotto']; ?></td>
      ...
      <h3 style="text-align:right;" id="prezzo">Prezzo Totale: <?php echo number_format($prezzoTotale,2); ?>€</h3>
    </div>
  </div>
  <div class="col-md-6">
    <div class="container">
      <h2 class="text-center">Le tue comunicazioni:</h2>
      <div class="form-group">
        <label for="comunicazioni"></label>
        <textarea class="form-control" rows="5" id="comment"><?php echo $_SESSION['comunicazione']; ?></textarea>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-sm-12">
    <div class="table-responsive">
      <table class="table table-striped ">
            <tr class="righe">
              <th id="luogo" class= "sinistra">Luogo di ritiro:</td>
              <td headers="luogo" class= "destra"><?php echo $_SESSION['indirizzo']; ?> </td>
            </tr>
            <tr class="righe">
              <th id="orario" class= "sinistra">Orario:</td>
              <td headers="orario"class= "destra"><?php echo substr($_SESSION['orario'],11,5) . "  del ".substr($_SESSION['orario'],8,2) . substr($_SESSION['orario'],4,4) . substr($_SESSION['orario'],0,4); ?> </td>
            </tr>
            <tr class="righe">
              <th id="pagamento" class= "sinistra">Pagamento:</td>
              <td headers="pagamento" class= "destra"><?php echo $_SESSION['pagamento']; ?> </td>
            </tr>
          </table>
        </div>
      </div>
    ...
    <button id="left" type="button" class="btn btn-outline-dark" onclick="window.location='pagamento.php'"><< Modalità di pagamento</button>
    </div>
    </div>
    <div class="row">
      <div class="col-sm-12 text-right">
    <button id="right" type="button" class="btn btn-outline-dark" onclick="window.location='php/ordine.php'">Invia</button>
    </div>
    </div>
