...
if(!isset($_SESSION['carrello'])){
  header("location: carrello.php?error=");
}
 ?>
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container">
      ...
      <p class="text-center font-italic">La pida se parsot la pis un po ma tot</p>
        <h2 class="text-center">Comunicazioni</h2>
    </div>
  </div>
      ...
      <div class="col-xs-6">
        <li class="nav-item">
          <a class="navbar-brand" href="#">
            ...
            <!-- <img src="res/carrello.jpg" alt="Logo" style="width:40px;"> -->
          </a>
        </li>
      </div>
      <div class="col-xs-6">
...
<form action="php/addComunicazione.php" method="post">
  <div class="row">
    <div class="col-sm-12">
      <div class="container">
        <h2 class="text-center">Comunicazioni al venditore:</h2>
          <div class="form-group">
            <label for="comunicazioni"></label>
            <textarea class="form-control" name="testo" rows="5" id="comment"><?php
              if(isset($_SESSION['comunicazione'])){
                echo $_SESSION['comunicazione'];
              }
               ?></textarea>
          </div>
      </div>
  ...
  <button id="left" type="button" class="btn btn-outline-dark" onclick="window.location='carrello.php'"><< Carrello</button>
</div>
</div>
<div class="row">
  <div class="col-sm-12 text-right">
  <input id="right" type="submit"  class="btn btn-outline-dark" value="Indirizzo e ora di consegna >>">
</div>
</div>
</form>
