...
<div class="row">
  <div class="col-sm-12">
    <p class="text-center">Ti ringraziamo per aver scelto "E Cantoun Dla Pida".</br>
        Scopri il nostro menù, aggiungi al carrello ogni prelibatezza che desidiri, decidi ora e luogo di consegna, modalità di pagameno e il gioco è fatto!</br>
        Semplice no? La miglior pida romagnola in pochi click.</br>
        Non perdere le nostre specialità vegetariane, le riconoscerai attraverso la foglia accanto ai valori nutrizionali.</br>
        E ricorda, "la pida se parsot la pis un po' ma tot!"
    </p>
  </div>
